...
from cmds import base, dot, label, mov, nop, jmp, jpc, pra, prb, lod, Str, psh, pop, srt, ret
from util import *
import vals
...
'''
CMD_NAMES = [".", "label", "nop", "mov", "jmp", "jpc", "pra", "prb", "lod", "str", "psh", "pop", "srt", "ret"]
CMD_CLASSES = [dot.dot, label.label, nop.nop, mov.mov, jmp.jmp, jpc.jpc, pra.pra, prb.prb, lod.lod, Str.Str, psh.psh, pop.pop, srt.srt, ret.ret]
